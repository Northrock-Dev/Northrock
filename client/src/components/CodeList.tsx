        ...
        >
          <div className="p-4 border-b border-neutral-100">
            <div className="flex justify-between items-center">
              <div>
                <span className="inline-block px-2 py-1 rounded-md text-xs font-mono bg-primary-100 text-primary-800 mb-2">
              ...
              <CollapsibleTrigger asChild>
                <Button variant="ghost" size="sm" className="text-neutral-400 hover:text-neutral-700 p-1">
                  <ChevronDown className={`h-5 w-5 transition-transform ${expandedCodes.includes(code.id) ? 'transform rotate-180' : ''}`} />
                  <span className="sr-only">Toggle</span>
                </Button>
              </CollapsibleTrigger>
            </div>
            <p className="text-neutral-600 mt-1">{code.title}</p>
          </div>

          <CollapsibleContent className="p-4 bg-neutral-50">
            <div className="mb-3">
              <h4 className="text-sm font-semibold text-neutral-700 mb-1">Description</h4>
              <p className="text-neutral-600">{code.description}</p>
            </div>
            <div>
              <h4 className="text-sm font-semibold text-neutral-700 mb-1">Example Usage</h4>
              <div className="bg-neutral-100 rounded p-3 font-mono text-sm text-neutral-700">
                {code.example}
              </div>
            </div>
          </CollapsibleContent>
